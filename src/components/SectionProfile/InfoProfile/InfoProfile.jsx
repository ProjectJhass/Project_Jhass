...
export const InfoProfile = ({ img, nombre, rol, telefono, correo, Trabajadas, Ausencias, Vacaciones }) => {
  return (
        ...
        <div className='w-full mt-[20px]'>
          ...
          <div>
            ...
            <div className='flex'>
              ...
              <div className='mr-[5px]'>
                <p className='font-Open-Sans text-[17px] py-[10px] pr-[5px]'>{Trabajadas}</p>
                <p className='font-Open-Sans text-[17px] pb-[10px] pr-[5px]'>{Ausencias}</p>
                <p className='font-Open-Sans text-[17px] pb-[10px] pr-[5px]'>{Vacaciones}</p>
              </div>
            </div>
          </div>
        </div>
