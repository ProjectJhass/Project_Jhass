    ...
    <div className="fixed inset-0 flex justify-center items-center z-50">
      <div className="relative p-6 bg-white shadow-lg rounded-lg w-11/12 md:w-1/2 lg:w-1/3 max-w-md">
        <button onClick={onClose} className="absolute top-4 right-4 text-gray-500 hover:text-gray-700">
          <img src="https://res.cloudinary.com/dnweqtuch/image/upload/v1724450505/ContentImagesJhass/dfzjdfz4hz5bixvrkfex.png" alt="Close" className="w-4 h-4" />
        </button>
          ...
          <>
            <div className="flex flex-col items-center">
              ...
              <div className="text-center mb-4">
                <div className="text-xl font-semibold">{user.nombre ? `${user.nombre} ${user.apellido}` : 'Usuario'}</div>
            ...
            <div className="bg-gray-100 p-4 rounded-lg shadow-md">
              ...
              <div className="flex items-center mb-3">
                ...
                <span className="text-gray-700">{user.edad ? `${user.edad} años` : 'Edad no disponible'}</span>
              </div>
              <div className="flex items-center">
                <FaPhone className="text-gray-600 mr-3" />
                <span className="text-gray-700">{user.telefono || '+1 234 567 890'}</span>
              </div>
            </div>
