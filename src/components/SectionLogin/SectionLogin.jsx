...
export const SectionLogin = () => {
  ...
  return (
    <div className="relative min-h-screen flex justify-center items-center bg-cover bg-center bg-[url('https://res.cloudinary.com/dnweqtuch/image/upload/v1724450240/ContentImagesJhass/qwnv6tsgjmwyfkvizzoq.jpg')]">
      ...
      <div className="relative bg-black bg-opacity-75 p-6 md:p-12 rounded-lg shadow-lg max-w-xs md:max-w-md  w-full z-10">
        <button
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-center text-white mb-6">Iniciar Sesión</h2>
        <form onSubmit={handleLogin}>
          ...
          <input
            ...
            />
            {errors.correo && <p className="text-red-500 text-sm my-4">{errors.correo}</p>}
          </div>
          <div className="mb-4">
          ...
          {generalError && <p className="text-red-500 text-center my-4">{generalError}</p>}
