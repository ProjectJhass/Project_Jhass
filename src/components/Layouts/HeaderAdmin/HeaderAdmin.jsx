    ...
    <div className="container mx-auto flex items-center justify-evenly py-4 text-2xl">
      ...
      <nav>
        <ul className="flex space-x-8 text-xl items-center">
          <li><a href="#" className="text-black font-serif">Inventario</a></li>
          <li><a href="#" className="text-black font-serif">Ventas</a></li>
          <li><a href="#" className="text-black font-serif">Calendario</a></li>
        </ul>
      </nav>
      <div className='flex items-center'>
      <img src={usuario} alt="Logo" className="h-8 w-8 mr-[10px]" />
        <h2 className=" text-black text-[21px] font-serif">Santiago Uribe Bohorquez</h2>
      </div>
    </div>
  </header>
  )
