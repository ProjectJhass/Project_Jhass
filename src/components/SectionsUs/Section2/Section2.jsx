...
export const Section2 = () => {
  return (
    <section className='flex items-center place-content-center bg-[#020C1D] w-full h-[700px] ' >
        ...
        <h3  className='font-Open-Sans font-semibold text-[20px] m-[10px]'>Vision</h3>
