...
const [selectedCardId, setSelectedCardId] = useState(null);
  ...
  return (
    <AppContext.Provider value={{isOpaque, setisOpaque, estadoModal1, setestadoModal1, cards, setCards, modalIsOpen, setModalIsOpen, ModalTrackingIsOpen, setModalTrackingIsOpen, selectedCardId, setSelectedCardId, currentCard, setCurrentCard, isModalOpen, setIsModalOpen, currentCard2, setCurrentCard2 }} >
    {children}
    </AppContext.Provider>
  )
}